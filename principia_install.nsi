; TODO: The upstream installer should preferably be configurable enough to make this copy unnecessary
SetCompressor lzma
XPStyle on
...
!define MUI_WELCOMEFINISHPAGE_BITMAP "principia\packaging\installer\welcome.bmp"
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "principia\packaging\installer\unwelcome.bmp"

!define MUI_FINISHPAGE_RUN "$INSTDIR/principia.exe"
!define MUI_FINISHPAGE_RUN_TEXT "Run Principia"

!insertmacro MUI_PAGE_WELCOME
!insertmacro MUI_PAGE_LICENSE "principia\LICENSE.md"
...
Section "Core Files (required)" SecCore
    ...
    File "build_principia\principia.exe"
	File /r "principia\data"
